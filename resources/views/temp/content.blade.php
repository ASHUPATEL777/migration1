                     ...
                     <div class="row d_flex">
                        <div class="col-md-5">
                           <div class="about_box_text">
                              ...
                              <p>There are many variations of passages crof 
                        ...
                        <div class=" col-md-7  pppp">
                           <div class="about_box_img">
                              <figure><img src="{{asset ('temp/images/about_img.png') }}" alt="#" /></figure>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="tab-pane fade show active" id="home-md" role="tabpanel" aria-labelledby="home-tab-md">
                        <div class="row">
                           <div class="col-md-4 col-sm-6 padding_0 margin_right20">
                              <div class="services">
                                 <div class="services_img">
                                    <figure><img src="{{ asset('temp/images/service_img1.png') }}" alt="#" />  </figure>
                                    <div class="ho_dist">
                           ...
                           <div class="col-md-4 col-sm-6 padding_0 margin_top70p margin_right20 margin_left20">
                              <div class="services">
                                 <div class="services_img">
                                    <figure><img src="{{asset ('tempimages/service_img2.png') }}" alt="#" />  </figure>
                                    <div class="ho_dist">
                                       <span>Reader will be distracted</span>
                                    </div>
                                 </div>
                           ...
                           <div class="col-md-4 col-sm-6 padding_0 margin_left20">
                              <div class="services">
                                 <div class="services_img">
                                    <figure><img src="{{ asset('temp/images/service_img3.png')}}" alt="#" />  </figure>
                                    <div class="ho_dist">
                                       <span>Reader will be distracted</span>
                                    </div>
                                 </div>
                           ...
                           <div class="col-md-4 offset-md-8 col-sm-6 padding_0 margin_top170">
                              <div class="services margin_left60">
                                 <div class="services_img">
                                    <figure><img src="{{ asset('temp/images/service_img4.png')}}" alt="#" />  </figure>
                                    <div class="ho_dist">
                                       <span>Reader will be distracted</span>
                                    </div>
                                 </div>
                     ...
                     <div class="tab-pane fade" id="profile-md" role="tabpanel" aria-labelledby="profile-tab-md">
                        <div class="row">
                           ...
                           <div class="col-md-4 col-sm-6 padding_0 margin_top70p margin_right20 margin_left20">
                              <div class="services">
                                 <div class="services_img">
                                    <figure><img src="{{ asset('temp/images/service_img2.png')}}" alt="#" />  </figure>
                                    <div class="ho_dist">
                                       <span>Reader will be distracted</span>
                                    </div>
                                 </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="instant_img">
                     <figure><img src="{{ asset('temp/images/pc.png')}}" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
